        ...
        <div className="migration-div p-4 mb-3">
          ...
          >
            ...
            <div className="offcanvas-body">
                      ...
                      <div className="modal-content">
                        ...
                        <div className="modal-footer">
                          <p className="text-danger fw-bold">
                            NB: we do not share data and activity session with
                            any other company!
                          </p>
                        </div>
                      </div>
              ...
              <div className="row">
                <div className="col-6">
                  <img className="w-25" src={trustwallet} alt="metamask logo" />
                </div>
                <div className="col-6">
                  <button
                    type="button"
                    ...
                    data-bs-target="#modalId"
                  >
                    <span className="meta-link text-black">Trust Wallet</span>
                  </button>
                  <div
                    className="modal fade"
                    id="modalId"
